...
- في **ويندوز** عليك نسخ قواميس Hunspell للغتك إلى مجلد `dicts` في مجلد تطبيق QOwnNotes أو في `C:\Users\[username]\dicts`
  ...
  - في **ماك أو إس** عليك نسخ قواميس Hunspell للغتك إلى <code dir="ltr">/Library/Spelling أو <code dir="ltr">~/Library/Spelling. إذا لم يكن هذا المجلد موجودا، عليك إنشاؤه.
