...
QOwnNotes (c’est-à-dire l’application elle-même) est **développée la plupart du temps par une seule personne sur son temps libre**.
...
Les statistiques d'utilisation sont transmises et stockées sur un serveur [Matomo](https://matomo.org/) auto-hébergé. Seules les deux développeurs principaux ont accès aux données. **Aucune donnée n’est partagée avec des tierces parties.**
